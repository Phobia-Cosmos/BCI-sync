...
args.exp_name = "blurry10_symN20" # WebVision-V1-2, Food-101N: blurry10, others: blurry10_symN20, blurry10_symN40, blurry10_symN60, blurry10_asymN20, blurry10_asymN40
...
command = f'{sys.executable} main.py {args_text}'
