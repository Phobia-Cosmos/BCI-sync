...
_C.ATTACK.ALGO = 'SurrogateModelPGDAttack'

_C.ATTACK.POISONING_RATIO = 0.

_C.ATTACK.DATA_TYPE = 'batch'

_C.ATTACK.OBJECTIVE = CfgNode()

_C.ATTACK.OBJECTIVE.NAMES = ['NHEAttackingObjective']
# Contrastive_Attacking_Objective2
_C.ATTACK.OBJECTIVE.BLEAttackingObjective = CfgNode()
_C.ATTACK.OBJECTIVE.BLEAttackingObjective.UPDATE_STEP_SCALE = 1.0  # optional [1.0, 0.5, 0.1]
# Maximizing_Cross_Entropy_OURS
_C.ATTACK.OBJECTIVE.NHEAttackingObjective = CfgNode()
_C.ATTACK.OBJECTIVE.NHEAttackingObjective.UPDATE_STEP_SCALE = 0.1 # optional [1.0, 0.5, 0.1]

_C.ATTACK.UPDATE_STEP_SCALE = 1.0 # default 1.0
...
_C.TENT_D.ENTROPY_THRESHOLD = False
# refer to rotta
_C.TENT_D.THRESHOLD_VALUE = 0.05

_C.TENT_D.M_DIA = False

_C.TENT_D.MEDIA_BN = False

# https://github.com/ml-postech/MedBN-robust-test-time-adaptation/blob/main/conf.py#L120
_C.TENT_D.BN_MOMENTUM = 0.2 

_C.TENT_D.EMA_MODEL = False
# refer to cotta
_C.TENT_D.MODEL_MOMENTUM = 0.001

_C.TENT_D.DATA_AUGMENTATION = False

_C.TENT_D.ENSEMBLE_SOURCE_PARAM = False
#refer to roid
_C.TENT_D.ENSEMBLE_MOMENTUM = 0.01
...
def get_num_classes(dataset_name: str):
    dataset_name2num_classes = {"cifar10": 10, "cifar10_c": 10, "cifar100": 100,  "cifar100_c": 100,
                                ...
                                "domainnet126": 126, "ccc": 1000, "modelnet40_c": 40
                                }
