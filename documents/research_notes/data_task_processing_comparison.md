...
| Script | Data/tasks |
| --- | --- |
| `code/workspace_tools/run_ssvep_feature_pipeline.py` | EEG SSVEP, Tsinghua S1 |
| `code/workspace_tools/run_additional_bci_pipelines.py` | EEG MI/ME, EEG P300, fNIRS |
| `code/workspace_tools/run_emg_fmri_pipelines.py` | EMG gestures, auditory fMRI |

Run:

```bash
python3 -B code/workspace_tools/run_ssvep_feature_pipeline.py
python3 -B code/workspace_tools/run_additional_bci_pipelines.py
python3 -B code/workspace_tools/run_emg_fmri_pipelines.py
```
